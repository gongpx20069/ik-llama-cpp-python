...
pip install https://github.com/gongpx20069/ik-llama-cpp-python/releases/download/v0.1.5/ik_llama_cpp_python_cuda-0.1.5-cp312-cp312-manylinux_2_28_x86_64.whl
```
